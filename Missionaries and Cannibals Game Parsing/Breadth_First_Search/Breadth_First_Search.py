...
def bfs(initial_state):
    graph = pydot.Dot(graph_type='digraph',label="Visualization of Missionaries and Cannibals State Space",fontsize="30", color="red",
            ...
            for child in children:
                if child.state not in explored:
                    ...
                    if child.goal_test():
                        ...
                        draw_legend(graph)
                        graph.write_png('BFS_State_Space_Tree.png')
